...
from Lossy_thread_ablation import (
...
from LossLess_thread_ablation import (
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="fastq compress (ablation, multithread version)")
