...
def main():
    # 与压缩脚本一致：压缩输出目录
    input_dir = "/media/compress/新加卷1/output/测试集1/Lossy"     # 解压的输入目录（= 压缩脚本的输出目录）
    decompressed_dir = "/media/compress/新加卷/output/测试集1_FastqCA-Lossy_decompressed"  # 解压后的FASTQ目录
